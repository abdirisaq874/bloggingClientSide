...
const SignUp = () => {
  ...
  const isValidPassword = (password, errors) => {
    ...
    // For now, it's the same as in the login form
  ...
  const handleSubmit = (e) => {
    ...
    // Add your custom validation logic here as needed
    // For example, validating the first name and last name
